...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(15, 0, 0); // set to default 8 from 0 on quickstart quide
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(25, 0, 0);  // set to default 8 from 0 on quickstart quide
